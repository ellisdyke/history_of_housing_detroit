...
st.title("DLBA Sales, Re-Occupancy, and HOLC Redlining Overlay (2014–2024)")
...
def load_holc_data():
    ...
    params = {
        'where': "ST='MI'",  # Filter for Michigan
        'outFields': '*',
        'f': 'geojson'
    }
...
# Setup HOLC shapes if available
holc_shapes = []
holc_color_map = {
    'A': ('#00A86B', 1),
    'B': ('#0067A5', 2),
...
fig = go.Figure(
    ...
    layout=go.Layout(
        title="DLBA Sales and Re-Occupancy in Detroit (2014–2024) with HOLC Redlining Overlay",
